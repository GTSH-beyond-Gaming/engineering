  ...
  theme: {
    extend: {
      colors: {
        ...
        text: {
          primary: '#2C3E50',    // Haupttext (Dunkelgrau)
          secondary: '#546E7A',  // Sekundärtext
          light: '#90A4AE',      // Hints/Disabled
        ...
        dark: {
          bg: '#1A252F',         // Dunkel-Modus Hintergrund
          card: '#2C3E50',       // Dunkel-Modus Cards
          border: '#3D5A73',     // Dunkel-Modus Borders
        },
        // Status-Farben
        success: '#43A047',
        warning: '#FB8C00',
