  ...
  return (
    <div className="min-h-screen bg-transparent transition-colors duration-500">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <p className="text-white/70 text-white/60 mb-12">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <p className="text-white/80 text-white/60 text-sm leading-relaxed">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <div className="space-y-2 text-white/90 text-white/90">
            <p className="font-medium text-gray-900 text-white">Randolf Hahn</p>
            ...
            <div className="pt-3 space-y-2">
              <a 
                ...
                className="flex items-center gap-2 text-sm text-white/80 text-white/60 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
              >
                <span>Telefon:</span>
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <p className="text-white/80 text-white/60 text-sm leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-white/80 text-white/60 mb-4">
            <li>IP-Adresse</li>
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <ul className="space-y-3 text-sm text-white/80 text-white/60 mb-4">
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Auskunft</strong>
              <span>über Ihre bei uns gespeicherten personenbezogenen Daten zu erhalten (Art. 15 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Berichtigung</strong>
              <span>unrichtiger oder unvollständiger Daten zu verlangen (Art. 16 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Löschung</strong>
              <span>Ihrer gespeicherten Daten zu fordern (Art. 17 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Einschränkung</strong>
              <span>der Verarbeitung Ihrer Daten zu verlangen (Art. 18 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Datenübertragbarkeit</strong>
              <span>zu fordern (Art. 20 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Widerspruch</strong>
              <span>gegen die Verarbeitung Ihrer Daten einzulegen (Art. 21 DSGVO)</span>
            </li>
            <li className="flex gap-2">
              <strong className="text-gray-900 text-white shrink-0">Beschwerde</strong>
