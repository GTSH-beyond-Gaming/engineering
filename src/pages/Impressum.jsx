      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <div className="space-y-2 text-white/90 text-white/90">
            ...
            <p className="text-sm text-white/70 text-white/60 mt-2">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <div className="space-y-3">
            <a 
              ...
              className="flex items-center gap-3 text-white/90 text-white/90 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
            >
            ...
            <div className="flex items-center gap-3 text-white/90 text-white/90">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <p className="text-white/90 text-white/90">Randolf Hahn</p>
          <p className="text-white/70 text-white/60 text-sm mt-1">
            (Anschrift wie oben)
          </p>
        </section>
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <p className="text-white/90 text-white/90 mb-3">
          ...
          <p className="text-white/70 text-white/60 text-sm">
        ...
        <section className="bg-transparent rounded-2xl p-6 sm:p-8 mb-6 shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-500">
          ...
          <p className="text-white/80 text-white/60 text-sm mt-3 leading-relaxed">
