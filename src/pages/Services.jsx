...
export default function Services() {
  ...
  return (
    <div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="card">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Einmalig + €50/Monat AI-Kosten</p>
              </div>
      ...
      {/* E-Learning */}
      <section className="section dark:bg-gray-900" id="elearning">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="mb-6 text-primary dark:text-white">E-Learning Plattformen</h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
            ...
            <div className="card mb-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="mb-4 dark:text-white">Custom LMS</h3>
                ...
                <div>
                  <h3 className="mb-4 dark:text-white">Preise</h3>
                  <div className="space-y-4">
                    <div>
                      <p className="font-semibold text-lg dark:text-white">Basis-Plattform</p>
                      <p className="text-3xl font-bold text-primary dark:text-primary mb-2">€5.000</p>
                      <p className="text-sm text-gray-700 dark:text-gray-300">Setup + 5 Kurse</p>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
                      <p className="font-semibold text-lg dark:text-white">Enterprise</p>
                      <p className="text-3xl font-bold text-primary dark:text-primary mb-2">Ab €12.000</p>
                      <p className="text-sm text-gray-700 dark:text-gray-300">Custom Features + Integration + Branding</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card bg-gradient-to-br from-primary via-primary to-primary-dark text-white border-2 border-white/20">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition-colors border-2 border-secondary">
                  ...
                  <p className="text-3xl font-bold mb-2 text-secondary">€2.400</p>
