...
export default function Home() {
  return (
    <div>
        ...
        <div className="container-custom text-center relative z-10">
          ...
          >
            <h1 className="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="text-white/80">konvertieren.</span>
              <br />
              <span className="text-white">Automation die</span>{" "}
              <span className="text-white/80">skaliert.</span>
            </h1>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl mb-4 max-w-3xl mx-auto opacity-90"
          >
            Web-Engineering + KI-Automation für KMU in Thüringen.
          </motion.p>
      ...
      {/* Testimonials - Importierte Komponente (keine Platzhalter!) */}
      <Testimonials />
      ...
      <section className="section">
        <div className="container-custom text-center">
          ...
          <p className="text-lg text-white/80 text-white/60 mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <p className="text-xl text-white/80 text-white/90 mb-2">⭐⭐⭐⭐⭐</p>
              <p className="text-sm text-white/80 text-white/60">Google Reviews (GTSH Gaming)</p>
            </div>
            <div className="card">
              <div className="text-5xl font-bold text-white/80 mb-2">20%</div>
              <p className="text-xl text-white/80 text-white/90 mb-2">Pionier-Rabatt</p>
              <p className="text-sm text-white/80 text-white/60">Für unsere ersten Kunden!</p>
            </div>
            <div className="card">
              <div className="text-5xl font-bold text-primary mb-2">2026</div>
              <p className="text-xl text-white/80 text-white/90 mb-2">Frisch gestartet</p>
              <p className="text-sm text-white/80 text-white/60">Motiviert & hungrig</p>
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/80 text-white/60">Modern Tech-Stack</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-green-500 text-xl">✓</span>
                    <div>
                      ...
                      <p className="text-sm text-white/80 text-white/60">Performance-optimiert</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-green-500 text-xl">✓</span>
                    <div>
                      ...
                      <p className="text-sm text-white/80 text-white/60">Cookie-Banner, Datenschutz</p>
                    </div>
                  </div>
                </div>
