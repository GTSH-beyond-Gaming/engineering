      ...
      >
        ...
        {!isOpen && (
          <span className="absolute -top-0.5 -right-0.5 flex h-3.5 w-3.5">
            ...
            <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-transparent"></span>
          </span>
        )}
      </motion.button>
                  ...
                  <div className={`max-w-[85%] p-3 rounded-2xl text-sm ${
                    ...
                    {msg.role === 'assistant' && parseLinks(msg.content) && (
                      <button
                        ...
                        className="block mt-2 text-white/80 hover:text-secondary-dark font-medium text-xs underline underline-offset-2"
                      >
