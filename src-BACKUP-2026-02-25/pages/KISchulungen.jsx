        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              {...fadeInUp}
            >
              <h2 className="mb-4 text-gray-900 dark:text-white">Unsere KI-Workshops</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Halbtags, 4h</span>
                </div>
                <h3 className="mb-3 dark:text-white">KI-Basics Workshop</h3>
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Ganztags, 8h</span>
                </div>
                <h3 className="mb-3 dark:text-white">KI-Integration für Teams</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">2 Tage, 16h</span>
                </div>
                <h3 className="mb-3 dark:text-white">Individuelles KI-Training</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              {...fadeInUp}
            >
              <h2 className="mb-4 text-gray-900 dark:text-white">Warum KI-Schulungen?</h2>
              <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <h3 className="text-lg mb-2 dark:text-white">Messbarer ROI</h3>
              ...
              >
                ...
                <h3 className="text-lg mb-2 dark:text-white">Wettbewerbsvorteil</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              >
                ...
                <h3 className="text-lg mb-2 dark:text-white">DSGVO-konform</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              >
                ...
                <h3 className="text-lg mb-2 dark:text-white">100% Praxisnah</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              {...fadeInUp}
            >
              <h2 className="mb-4 text-gray-900 dark:text-white">So läuft eine Schulung ab</h2>
              ...
              {[
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-lg mt-2 mb-2 dark:text-white">{item.title}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {item.description}
                    </p>
                  </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            <motion.div
              ...
              {...fadeInUp}
            >
              <h2 className="mb-4 text-gray-900 dark:text-white">Häufige Fragen zu KI-Schulungen</h2>
