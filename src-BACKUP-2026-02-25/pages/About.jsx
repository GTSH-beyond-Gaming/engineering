    ...
    <div>
      ...
      <section className="section dark:bg-gray-900">
        <div className="container-custom max-w-4xl">
          <h2 className="mb-6 dark:text-white">Vom Fundament zum Code</h2>
          <div className="prose prose-lg dark:prose-invert">
            ...
            <h3 className="text-xl font-semibold mb-4 dark:text-white">Abseits des Codes</h3>
      ...
      <section className="section bg-gray-50 dark:bg-gray-800">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="card">
              <h3 className="mb-4 dark:text-white">Mission</h3>
            ...
            <div className="card">
              <h3 className="mb-4 dark:text-white">Vision</h3>
              <p className="text-gray-700 dark:text-gray-300">
      ...
      <section className="section dark:bg-gray-900">
        <div className="container-custom">
          <h2 className="text-center mb-12 dark:text-white">Unsere Werte</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="mb-3 dark:text-white">Qualität</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 dark:text-white">Effizienz</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 dark:text-white">Partnerschaft</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="section bg-gray-50 dark:bg-gray-800">
        <div className="container-custom max-w-6xl">
          <h2 className="text-center mb-12 dark:text-white">Das Team</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card flex flex-col items-center text-center">
              ...
              <h3 className="mb-2 dark:text-white">Randolf Hahn</h3>
            ...
            <div className="card flex flex-col items-center text-center bg-gradient-to-br from-primary/5 to-secondary/5 border-2 border-primary/20">
              ...
              <h3 className="mb-2 dark:text-white">Clawdius</h3>
              <p className="text-secondary font-semibold mb-4">KI-Assistent & Co-Engineer ("Der Überhummer")</p>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <section className="section dark:bg-gray-900">
        <div className="container-custom">
          <h2 className="text-center mb-12 dark:text-white">Unsere Technologien</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              <div key={i} className="card text-center hover:scale-110 transition-transform">
                <p className="font-semibold text-gray-700 dark:text-gray-300">{tech}</p>
              </div>
            ))}
          </div>
        </div>
