        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="card text-center">
              ...
              <h3 className="mb-2 dark:text-white">Telefon</h3>
              <a href="tel:+4917684940127" className="text-secondary hover:text-secondary-dark transition-colors">
                +49 176 84940127
              </a>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="mb-2 dark:text-white">Standort</h3>
      ...
      <section className="section bg-gray-50 dark:bg-gray-800">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Calendly */}
            <div>
              <h2 className="mb-6 dark:text-white">Termin buchen</h2>
            ...
            {/* Contact Form */}
            <div>
              <h2 className="mb-6 dark:text-white">Oder schreiben Sie uns</h2>
