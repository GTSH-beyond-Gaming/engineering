  ...
  return (
    <div>
      ...
      {projects.map((project, index) => (
        <section
          key={project.id}
          className={`section ${index % 2 === 0 ? 'dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800'}`}
        >
          <div className="container-custom max-w-5xl">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="relative rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-2xl bg-white dark:bg-gray-800 mb-8"
            >
              {/* Browser Bar */}
              <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex-1 mx-4">
                  <div className="bg-white dark:bg-gray-700 rounded-md px-3 py-1.5 text-xs text-gray-500 dark:text-gray-300 text-center font-mono max-w-md mx-auto">
              ...
              {/* Screenshot Area */}
              <div className="relative bg-gray-100 dark:bg-gray-900 overflow-hidden" style={{ minHeight: '300px' }}>
                <img
                ...
                <div className="hidden items-center justify-center h-64 bg-gradient-to-br from-primary/20 to-secondary/20">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Screenshot kommt bald</p>
                  </div>
                </div>
                ...
                {project.status === 'LIVE' && (
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-8">
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-white text-primary font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors shadow-2xl"
                    >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="card"
              >
                <h2 className="text-2xl font-bold mb-1 dark:text-white">{project.title}</h2>
                <p className="text-primary dark:text-secondary font-medium mb-4">{project.subtitle}</p>
                <p className="text-gray-600 dark:text-gray-300 mb-6">{project.description}</p>

                <h4 className="font-semibold mb-3 dark:text-white">Highlights:</h4>
                ...
                <h4 className="font-semibold mb-3 dark:text-white">Tech-Stack:</h4>
                <div className="flex flex-wrap gap-2">
                  {project.techStack.map((tech) => (
                    <span key={tech} className="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              >
                ...
                <div className="card bg-gradient-to-br from-primary/5 dark:from-primary/10 to-secondary/5 dark:to-secondary/10 border border-primary/20 dark:border-primary/30">
                  <h4 className="font-semibold mb-4 dark:text-white">Ergebnisse:</h4>
      ...
      <section className="section bg-gray-50 dark:bg-gray-800">
        <div className="container-custom max-w-4xl text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="mb-6 dark:text-white">Weitere Projekte folgen</h2>
