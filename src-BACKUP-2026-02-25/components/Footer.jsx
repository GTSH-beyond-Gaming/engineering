...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gray-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-dark-bg dark:to-dark-card text-gray-700 dark:text-gray-300 border-t border-gray-200 dark:border-dark-border transition-colors duration-300">
      ...
      <div className="container-custom py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="text-gray-900 dark:text-white font-semibold mb-4">Leistungen</h3>
            <ul className="space-y-2 text-sm">
