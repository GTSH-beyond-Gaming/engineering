    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-[100] p-4 bg-white dark:bg-gray-900 border-t-2 border-primary shadow-[0_-10px_40px_rgba(0,0,0,0.15)]"
        >
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 flex-shrink-0 w-full lg:w-auto">
                <button
                  ...
                  className="px-5 py-2.5 text-sm border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg font-medium transition-colors"
                >
              ...
              {showDetails && (
                ...
                >
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-4">
                    ...
                    <div className="flex items-start justify-between gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-semibold text-sm text-gray-900 dark:text-white">Technisch notwendig</h4>
                    ...
                    <div className="flex items-start justify-between gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex-1">
                        <h4 className="font-semibold text-sm text-gray-900 dark:text-white mb-1">Analyse & Statistiken</h4>
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex items-start justify-between gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex-1">
                        <h4 className="font-semibold text-sm text-gray-900 dark:text-white mb-1">Marketing & Personalisierung</h4>
                        <p className="text-xs text-gray-500 dark:text-gray-400">
